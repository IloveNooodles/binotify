...
<body>
    ...
    <form class="insert-album-form" action="/album/edit/<?=$data['album']['album_id']?>" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" disabled placeholder="Artist" value="<?=$data['album']['penyanyi']?>">
        <input type="hidden" placeholder="Artist" id="penyanyi" name="penyanyi" value="<?=$data['album']['penyanyi']?>">
